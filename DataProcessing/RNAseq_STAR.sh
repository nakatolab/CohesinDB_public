...
STARdir=/work/git/binaries/STAR-2.7.3a/bin/Linux_x86_64_static
...
echo -en "$prefix\t" > $log
/work/git/script_RNAseq/parse_starlog.pl $odir/$prefix.$build.Log.final.out >> $log

RSEMdir=/work/git/binaries/RSEM-1.3.3/
